(() => {
  ...
  const REQUEST_LABELS = {
    ...
    tawassu: { ar: "توسع | قرار الفرع الجديد", en: "Tawassu | New Branch Decision" },
  ...
  const TEXT_EN = {
    ...
    "نرتـــب قـــرارك": "We structure your decision",
    ...
    "ما القـــرار الذي يحتاج إلى تـــرتيب؟": "Which decision needs structure?",
    ...
    "أدوات لقـــرارات أدق": "Tools for sharper decisions",
    ...
    "استشـــارات ترتب القرار من أســـاسه": "Advisory that structures the decision at its core",
    ...
    "صيغة عمل تناسب قرارك": "A model matched to your decision",
  ...
  const ATTRIBUTE_EN = {
    ...
    "مرصد المخاطر المؤسسية": "Enterprise Risk Register",
    "شعار مصفوفة الصلاحيات": "Authority Matrix logo",
    "معاينة مستكشف مسارات النمو": "Growth Path Explorer preview",
    "شعار توسع لتقييم قرار الفرع الجديد": "Tawassu new branch decision logo",
    "محرك الفحص المسبق للصفقات": "Deal Readiness Check",
    "معاينة حاسبة الشراكات": "Partnership Calculator preview",
    "معاينة دليل التقييم والجاهزية": "Valuation and Readiness Guide preview",
    "شعار فاحص الامتثال الإعلاني": "Advertising Compliance Check logo",
    "شعار مخالفات لإعداد الاعتراض": "Mukhaalafat objection preparation logo",
